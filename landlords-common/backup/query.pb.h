...
class Query : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:muduo.Query) */ {
 public:
  ...
  void set_question(int index, const void* value, size_t size);
  ...
  void add_question(const void* value, size_t size);
...
class Answer : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:muduo.Answer) */ {
 public:
  ...
  void set_solution(int index, const void* value, size_t size);
  ...
  void add_solution(const void* value, size_t size);
...
inline void Query::set_question(int index, const void* value, size_t size) {
...
inline void Query::add_question(const void* value, size_t size) {
...
inline void Answer::set_solution(int index, const void* value, size_t size) {
...
inline void Answer::add_solution(const void* value, size_t size) {
